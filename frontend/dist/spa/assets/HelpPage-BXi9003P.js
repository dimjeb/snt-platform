...
### Хочу выдать садоводам логины и пароли

Это делается на сервере, одной командой. Если вы не администратор — попросите его.

Команда выдаёт **каждому свой пароль** и требует сменить его при первом входе. Пароли попадают в файл, который нужно распечатать, раздать и удалить.
